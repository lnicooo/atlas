...
public class NocComponentsCreator {
	...
	private void createScriptSCNoC(String diretorio){
		...
		try{
			...
			data_output.writeBytes("sccom -B/usr/bin -B/usr/bin -g SC_NoC/SC_InputModule.cpp\n");
			data_output.writeBytes("sccom -B/usr/bin -B/usr/bin -g SC_NoC/SC_OutputModule.cpp\n");
