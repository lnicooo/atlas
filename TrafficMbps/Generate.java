...
public class Generate extends Thread{
	...
	/**
	* Launch the thread responsible to generate the traffic scenery
	*/
	public void run(){
...
/***************************************************************************************/
				...
				target = Convert.formatAddressXY(target, flitWidth);
...
/***************************************************************************************/
				...
				payloadSize = packetSize - 6; // 6 = 2 flits header + 4 flits timestamp
