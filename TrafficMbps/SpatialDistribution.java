...
public class SpatialDistribution{
	...
	public String defineTarget(String target,int sourceX,int sourceY){
		...
		else if(target.equalsIgnoreCase("complement"))
			t=complement(sourceX,sourceY);
	 ...
	 * @return The target router address. 
	 */
	private String complement(int addX,int addY){
		int targetX,targetY;
		targetX = (dimX - 1) - addX;
		targetY = (dimY - 1) - addY;
		return Convert.formatAddressXY(targetX, targetY, flitWidth);
	...
	public static void main(String s[]){
		SpatialDistribution g =new SpatialDistribution(6,6,16);
