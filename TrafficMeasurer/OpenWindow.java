...
public class OpenWindow extends JFrame implements ActionListener{
	...
	/**
	 * Show scenery parameters in GUI.
	 */
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == bBrowse){
			...
			else if(!scenery.isSimulated()) {
				JOptionPane.showMessageDialog(null,"The selected scenery have not been simulated yet.","Error Message",JOptionPane.ERROR_MESSAGE);
			}
			else{
