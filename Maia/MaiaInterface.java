...
public class MaiaInterface extends NoCGenerationGUI implements ActionListener{
	...
	private void addComponents(){
		...
		//routing algorithm
		y=y+63;
		String[] availableAlgorithm = {"XY","West-First Non-Minimal", "North-Last Non-Minimal", "Negative-First Non-Minimal", "West-First Minimal", "North-Last Minimal", "Negative-First Minimal"};
		String selectedAlgorithm = "XY";
		if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmWFNM"))
			selectedAlgorithm = "West-First Non-Minimal";
		else if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmNLNM"))
			selectedAlgorithm = "North-Last Non-Minimal";
		else if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmNFNM"))
			selectedAlgorithm = "Negative-First Non-Minimal";
		else if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmWFM"))
			selectedAlgorithm = "West-First Minimal";
		else if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmNLM"))
			selectedAlgorithm = "North-Last Minimal";
