...
*********************************************************************************/
	...
	*/
   	public void copyNoCFiles(){
		...
		//copy the Hermes_crossbar files

		if(dimX == 2 && dimY == 2){		
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BR.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TR.vhd"), nocDir);
		}
		else if(dimY == 2){			
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BC.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BR.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TC.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TR.vhd"), nocDir);	
		}
		else if(dimX  == 2 ){			
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BR.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_CL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_CR.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TL.vhd"), nocDir);			
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TR.vhd"), nocDir);
		}
		else {			
			...
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_BR.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_CL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_CC.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_CR.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TL.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TC.vhd"), nocDir);
			ManipulateFile.copy(new File(sourceDir + "Hermes_crossbar_TR.vhd"), nocDir);
			...
			while(line!=null){
				...
				for (int cont=0; cont<vem; cont++){
					...
					if(word.equalsIgnoreCase("Chave"))
						...
						word = algorithm;
					else if(word.equalsIgnoreCase("routerType"))						
						word = routerType.substring(6);
...
*********************************************************************************/
	...
	public void writeVCOMInternalRouter(DataOutputStream data_output) throws Exception {
		...
		if(dimX == 2 && dimY == 2){					
			writeVCOM(data_output, "NOC/Hermes_crossbar_BL.vhd");		
			writeVCOM(data_output, "NOC/Hermes_crossbar_BR.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TL.vhd");		
			writeVCOM(data_output, "NOC/Hermes_crossbar_TR.vhd");
		}
		else if(dimY == 2){					
			writeVCOM(data_output, "NOC/Hermes_crossbar_BL.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_BC.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_BR.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TL.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TC.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TR.vhd");
		}
		else if(dimX == 2){				
			writeVCOM(data_output, "NOC/Hermes_crossbar_BL.vhd");		
			writeVCOM(data_output, "NOC/Hermes_crossbar_BR.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_CL.vhd");			
			writeVCOM(data_output, "NOC/Hermes_crossbar_CR.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TL.vhd");			
			writeVCOM(data_output, "NOC/Hermes_crossbar_TR.vhd");
		}
		else {					
			...
			writeVCOM(data_output, "NOC/Hermes_crossbar_BR.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_CL.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_CC.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_CR.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TL.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TC.vhd");
			writeVCOM(data_output, "NOC/Hermes_crossbar_TR.vhd");
