...
/**
 * This class contains the Normal traffic specific parameters and methods.  	
...
public class NormalTraffic extends Traffic{
	...
	/** indicates the standard deviation of the average rate in Mbps */
	...
	/**
	 * Creates a Normal traffic object with the default configuration. 
	 */
	public NormalTraffic(){
		super();
		averageRate = 0.0;
		minimalRate = 150.0;
		maximalRate = 250.0;
	 ...
	 */
	public NormalTraffic(double frequency, String target, int priority, int numberOfPackets, int packetSize, double averageRate,double minimalRate,double maximalRate,double standardDeviation, double increment){
	...
	/**
	 * Returns the standard deviation of the average rate in Mbps.
	 ...
	 * @param d
	 */
	public void setStandardDeviation(double d){ standardDeviation = d; }
	 ...
	 * @param increment The increment used in the rate generation between the minimum and maximum rates.
	 */
	public void set(double frequency, String target, int priority, int numberOfPackets, int packetSize, double averageRate,double minimalRate,double maximalRate,double standardDeviation, double increment){
	 ...
	 * @param increment The increment used in the rate generation between the minimum and maximum rates.
	 */
	public void set(double averageRate,double minimalRate,double maximalRate,double standardDeviation, double increment){
		this.averageRate = averageRate;
		this.minimalRate = minimalRate;
		this.maximalRate = maximalRate;
		this.standardDeviation = standardDeviation;
	 ...
	 * @param t A Normal traffic
	 */
	public void set(NormalTraffic t){
		set(t.getFrequency(),
			t.getTarget(),
			t.getPriority(),
	...
	public String getInfo(String tag1, String tag2){
		...
		info = info + "\n{" + tag1 + "AverageRate" + tag2 + "}" + averageRate + 
						...
						"\n{" + tag1 + "StandardDeviation" + tag2 + "}" + standardDeviation +
	...
	public void readParameters(File file, String tag1, String tag2){
		...
		try{
			...
			standardDeviation = Double.parseDouble(Default.readInfo(file, tag1 + "StandardDeviation"+ tag2));
	...
	public static void main(String s[]){
		NormalTraffic t = new NormalTraffic();
		...
		System.out.println("Standard Deviation = " + t.getStandardDeviation());
